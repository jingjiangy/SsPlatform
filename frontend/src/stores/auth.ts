...
function legacyModulesByRole(role: string): Set<AppModule> {
  const map: Record<string, Set<AppModule>> = {
    admin: new Set(["roles","users","materials","eval","eval_templates","robots","device_models","api_docs"]),
    evaluator: new Set(["users","materials","eval","eval_templates","robots","device_models","api_docs"]),
    rd: new Set(["materials","eval","eval_templates","robots","device_models","api_docs"]),
    collector: new Set(["materials","robots","device_models"]),
  };
